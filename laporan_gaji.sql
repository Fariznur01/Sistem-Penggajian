...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Jan 2022 pada 03.51
...
(9, 'Staff Administrasi', '1500000', '500000', '300000');
...
(80, '012022', '337409010212345', 'William', 'Laki-laki', 'Kepala Bidang', 30, 0, 0, 0),
(81, '012022', '11223344556677', 'Fania', 'Perempuan', 'Pegawai', 30, 0, 0, 0),
(82, '012022', '337409010267891', 'Pablo', 'Laki-laki', 'Kepala Bidang', 30, 0, 0, 0);
...
(12, '337409010267891', 'Pablo', 'pab', 'd9b1d7db4cd6e70935368a1efb10e377', 'Laki-laki', 'Kepala Bidang', '2021-08-12', 'Pegawai Tetap', '0711.png', '08123232123', 'nurfadillahyahoo.co.id@gmail.com', 'S1 Ekonomi', 'Semarang', 'https://maps.google.com/maps?q=ngaglik%20lama%20no%2063&t=&z=13&ie=UTF8&iwloc=&output=embed', 2),
...
--
ALTER TABLE `data_kehadiran`
  MODIFY `id_kehadiran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
